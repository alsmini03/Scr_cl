      ...
      <main className="p-4">
        {loading ? (
          ...
          <div className="space-y-4">
            ...
            {books.map((book) => (
              <div key={book.id} className="flex gap-4 p-4 bg-slate-50 rounded-2xl border border-slate-200 shadow-sm">
                <div
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                  <div>
                    <p className="font-bold truncate text-slate-900">{book.title}</p>
                  ...
                  <div className="flex gap-2 mt-3">
                    <button
                      ...
                      className="flex-1 py-2 bg-white border border-primary text-primary text-xs font-bold rounded-lg hover:bg-primary/5 transition-colors flex items-center justify-center gap-1"
                    >
                    ...
                    <button
                      ...
                      className="flex-1 py-2 bg-white border border-red-500 text-red-500 text-xs font-bold rounded-lg hover:bg-red-50 transition-colors flex items-center justify-center gap-1"
                    >
